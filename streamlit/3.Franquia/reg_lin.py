...
st.title("Previsão de Custos para abrir uma Franquia")

X = dados[['FrqAnual']] #dois [colchetes para dataframe]
y = dados['CusInic']
...
novo_valor = st.number_input("Insira Novo Valor de Franquia", min_value=1.0, max_value=999999.0, value=1500.0, step=0.01)
